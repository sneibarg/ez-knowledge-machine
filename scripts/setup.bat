...
for %%p in (km km-threads km-rest km-logging) do (
  ...
  if exist "!LISP_FILE!" (
    ...
    if "%%p"=="km-rest" (
      set "content=(defsystem "km-rest" :description "Automatically generated system for km-rest" :author "Generated by build script" :version "0.1.0" :depends-on ("km" "hunchentoot" "quux-hunchentoot" "jsown" "km-logging") :serial t :components ((:file "package") (:file "km-rest")))"
    )
    if "%%p"=="km-threads" (
      set "content=(defsystem "km-threads" :description "Automatically generated system for km-threads" :author "Generated by build script" :version "0.1.0" :depends-on ("cl-threadpool" "jsown" "bordeaux-threads") :serial t :components ((:file "package") (:file "km-threads")))"
    ) 
    if "%%p"=="km" (
    ...
    if "%%p"=="km-logging" (
      set "content=(defsystem "km-logging" :description "Automatically generated system for km-logging" :author "Generated by build script" :version "0.1.0" :depends-on ("log4cl") :serial t :components ((:file "package") (:file "km-logging")))"
    )
