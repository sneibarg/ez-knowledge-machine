...
for %%p in (km km-threads km-rest km-logging) do (
  ...
  if exist "!LISP_FILE!" (
    ...
    if "%%p"=="km-rest" (
      set "content=(defsystem "km-rest" :description "Automatically generated system for km-rest" :author "Generated by build script" :version "0.1.0" :depends-on ("km" "hunchentoot" "km-threads" "jsown" "km-logging") :serial t :components ((:file "package") (:file "km-rest")))"
    )
    if "%%p"=="km-threads" (
